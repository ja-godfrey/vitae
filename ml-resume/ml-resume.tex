...
\mynames{Godfrey/Jason,
  Godfrey/Jason\bibnamedelima J,
  Godfrey/J.,
  Godfrey/J.\bibnamedelimi M.}
...
\definecolor{MarkerColour}{HTML}{A41034}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Jason Godfrey, PhD}

  \makefield{\faEnvelope[regular]}{\href{mailto:jgod@umich.edu}{\texttt{jgod@umich.edu}}}
  \makefield{\faLinkedin}{\href{http://www.linkedin.com/in/jasonmgodfrey/}{\texttt{LinkedIn}}} 
  \makefield{\faUser}{\href{https://orcid.org/0000-0002-1977-9427}{\texttt{ORCID}}}
  \makefield{\faGithub}{\href{https://github.com/ja-godfrey}{\texttt{GitHub}}} %\\
  % \makefield{\faGraduationCap}{\href{https://scholar.google.com/citations?user=0S8vgAcAAAAJ&hl=en&oi=sra}{\texttt{Scholar}}}
  \makefield{\faGlobe}{\href{https://jasongodfrey.info}{\texttt{website}}}
  \par \tiny{last updated: \today}
...
\vspace{0.5em}
\makefield{\faChartLine}{Data Scientist experienced in fine-tuning large language models for education-focused policy analysis}
